...
public class ChefRegisteration extends AppCompatActivity {
    //states
    String[] Uttarakhand = {"Dehradun", "Haridwar", "Rishikesh"};
    String[] UttarPradesh = {"Lucknow", "Agra", "Kanpur"};

    //cities
    String[] Lucknow={"AlamBagh","HazratGanj","Aminabad"};
    String[] Agra={"CivilLines","Jaipuria","Kamala Nagar"};
    String[] Kanpur={"AryaNagar","AshokNagar","Barra"};
    String[] Dehradun={"RajpurRoad","Makkawala","Jakhan"};
    String[] Haridwar={"Kankhal","ShivalikNagar","Shyampur"};
    String[] Rishikesh={"Alodi","AkshayaNagar","Allipuram"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //isvalid is a user defined function to check whether every info entered is okay or not
                if (isValid()) {
