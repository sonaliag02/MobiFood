...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //We are adding animation to the logo and the project members name here
        imageVieww=(ImageView)findViewById(R.id.imageView);
        textView=(TextView)findViewById(R.id.textView7);

        //alpha animation puts fade in and fade out effects.
        //0f will set the view as invisible
        imageVieww.animate().alpha(0f).setDuration(0);
        textView.animate().alpha(0f).setDuration(0);

        //making logo visible by putting in 1f
        //listener is added such that as soon as logo animation is over
        //project member name's animation starts
        ...
        //now this is added because we need to automatically display the login screen after the animations.
